...
>
> - **WHO RED** — _Reaching Every District_ strategy (WHO/AFRO, 2008; revised 2017 & 2021 microplanning guide).
> - **WHO/Gavi RED-Q / REC** — _Reaching Every Community with Equity_, the zero-dose / missed-communities operationalization of RED used in Gavi 5.0 and the Equity Accelerator.
...
### Step 1 — Situation analysis & coverage review _(RED 5, RED-Q "Monitor")_
...
### Step 2 — Catchment & population mapping _(RED-Q "Identify")_
...
### Step 3 — Hard-to-reach & equity profiling _(RED-Q "Identify" + "Reach")_
...
### Step 4 — Service delivery strategy & session calendar _(RED 1)_

- **Purpose.** Decide _how_ each community is reached and _when_.
...
### Step 5 — Workforce & teaming _(WHO core element 6)_
...
### Step 6 — Vaccine, supplies & cold-chain forecast _(WHO core element 4, EVM 2.0)_
...
### Step 7 — Demand generation & social mobilization _(RED 3, RED-Q "Reach")_
...
### Step 8 — Logistics & transport _(WHO core element 5)_
...
### Step 9 — Budget with funding source _(WHO core element 8, Gavi HSS)_
...
### Step 10 — Supportive supervision plan _(RED 2)_
...
### Step 11 — Approval cascade _(RED 5)_
...
### Step 12 — Execution, monitoring & quarterly review _(RED 4 + RED-Q "Measure")_
...
12. At least one session this quarter has actual doses recorded _and_ a defaulter review has been run (Step 12).
...
- WHO. _Microplanning for Immunization Service Delivery using the Reaching Every District (RED) Strategy._ WHO/AFRO 2009; revised 2017 and 2021.
- WHO. _Reaching Every Community: Operational Guide for Immunization in Hard-to-Reach Areas._ 2018.
- Gavi. _Gavi 5.0 Strategy 2021–2025_ and _Equity Accelerator Framework._
- WHO. _Immunization Agenda 2030: A Global Strategy to Leave No One Behind._
- WHO & UNICEF. _Joint Reporting Form (JRF) on Immunization._ Annual.
- WHO. _Effective Vaccine Management (EVM) 2.0 Assessment Tool._
