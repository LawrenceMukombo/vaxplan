  ...
  app.get("/api/catalogue/vaccines/:id", isAuthenticated, requireTenant, async (req: any, res) => {
    try {
  ...
  app.patch("/api/catalogue/vaccines/:id", isAuthenticated, requireTenant, requirePermission("manage_users"), async (req: any, res) => {
    try {
      const data = req.body;
  ...
  app.patch("/api/catalogue/schedules/:id", isAuthenticated, requireTenant, requirePermission("manage_users"), async (req: any, res) => {
    try {
      const data = req.body;
  ...
  app.patch("/api/catalogue/commodities/:id", isAuthenticated, requireTenant, requirePermission("manage_users"), async (req: any, res) => {
    try {
      const data = req.body;
  ...
  // --- WASTAGE THRESHOLDS ---
  app.get("/api/catalogue/wastage-thresholds", isAuthenticated, requireTenant, async (req: any, res) => {
    try {
  ...
  app.post("/api/catalogue/wastage-thresholds", isAuthenticated, requireTenant, requirePermission("manage_users"), async (req: any, res) => {
    try {
  ...
  app.patch("/api/catalogue/wastage-thresholds/:id", isAuthenticated, requireTenant, requirePermission("manage_users"), async (req: any, res) => {
    try {
      const data = req.body;
  ...
  // --- SEED CATALOGUE ---
  app.post("/api/catalogue/seed", isAuthenticated, requireTenant, requirePermission("manage_users"), async (req: any, res) => {
    try {
      ...
      for (const c of seedCommodities) {
        ...
        if (!existing) {
          // @ts-ignore (type mismatch due to dynamic mapping)
