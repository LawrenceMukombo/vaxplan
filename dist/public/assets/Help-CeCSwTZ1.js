import{aV as Ge,B as i,u as He,j as e,at as D,au as M,bR as vt,aG as G,aH as xe,bO as wt,X as Fe,ag as Ze,W as o,c9 as xt,$ as bt,ca as kt,ac as m,cb as Oe,aD as St,ai as jt,A as Nt,ah as Ct,O as At,ak as Pt,a6 as Ie,b0 as Re,c0 as Tt,am as It,bb as qt,cc as Dt,bV as Mt,a7 as C,a8 as A,a9 as P,aa as T,aR as I,ab as d,af as q,ae as qe,D as Vt}from"./index-Bq514EkS.js";import{A as tt,a as nt,b as at,c as rt}from"./accordion-DKgvAQWQ.js";import{E as De}from"./external-link-Clg1Ufaw.js";import{P as Ot}from"./phone-BY7hEDzq.js";import{T as Me}from"./trash-2-DFA3iJ6l.js";import{S as we}from"./square-pen-Doa6UEwP.js";import{P as Rt}from"./progress-yk0_Jll2.js";import{A as Ft}from"./award-B-RMSxoB.js";import{M as Ke,r as Je}from"./index-BddhNCqB.js";import"./index-B5fJ5-dr.js";/**
 * @license lucide-react v0.453.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ze=Ge("Book",[["path",{d:"M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20",key:"k3hazp"}]]);/**
 * @license lucide-react v0.453.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ue=Ge("MessageCircle",[["path",{d:"M7.9 20A9 9 0 1 0 4 16.1L2 22Z",key:"vv11sd"}]]);/**
 * @license lucide-react v0.453.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xe=Ge("Trophy",[["path",{d:"M6 9H4.5a2.5 2.5 0 0 1 0-5H6",key:"17hqa7"}],["path",{d:"M18 9h1.5a2.5 2.5 0 0 0 0-5H18",key:"lmptdp"}],["path",{d:"M4 22h16",key:"57wxv0"}],["path",{d:"M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22",key:"1nw9bq"}],["path",{d:"M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22",key:"1np0yb"}],["path",{d:"M18 2H6v7a6 6 0 0 0 12 0V2Z",key:"u46fv3"}]]);/**
 * @license lucide-react v0.453.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ve=Ge("Video",[["path",{d:"m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5",key:"ftymec"}],["rect",{x:"2",y:"6",width:"14",height:"12",rx:"2",key:"158x01"}]]),Gt=`# VaxPlan — End-User Guide\r
\r
...
`,Et=`# VaxPlan — Facility Staff Quick-Start\r
\r
> Pin this card next to your workstation. It covers the things\r
> you'll do most days as a facility clerk or in-charge.\r
\r
## 1. Sign in\r
- Open the VaxPlan link your administrator gave you.\r
- Click **Sign in** and complete your organisation's login.\r
- The first time, you'll land on your facility's dashboard\r
  automatically.\r
- **Change your password** anytime: click your name (top-right) →\r
  **Change password**. Forgot it? Use **Forgot password?** on the\r
  sign-in screen and your admin will help.\r
\r
## 2. Add a community (village)\r
1. Sidebar → **Facilities** → **Communities** tab → **Add Community**.\r
2. Your facility is **pinned automatically** — you can't pick another.\r
3. Enter the **name**, then set the location: drop a **single pin**, or\r
   use **Draw Polygon Mode** to trace the **catchment boundary** on the map.\r
4. **Save.** If your boundary overlaps another community, a\r
   **Catchment overlap** panel appears — click **Request harmonization**\r
   to flag it and email the other facility's in-charge.\r
\r
> You can add **communities**, but only coordinators/admins can add a new\r
> **health facility** — that button won't show for you.\r
\r
## 3. Build a quarterly microplan\r
1. Sidebar → **Microplans → Routine**\r
2. **New microplan** → pick the quarter and year.\r
3. Tick the **villages** your facility will serve.\r
4. Confirm the **target population** (Registered / WorldPop / Manual).\r
5. Confirm the **antigens** to offer.\r
6. Declare **outreach sessions per village per month**.\r
7. **Save as draft** or **Submit for approval**.\r
\r
## 4. Plan the session days (itinerary)\r
1. Open a session → **Add Vaccination Session Itinerary Day**.\r
2. Enter the **lead vaccinator's** name, a **date at least 7 days ahead**,\r
   the **target population**, and tick at least one **community**.\r
3. The **Calculated Vaccine Supplies** panel estimates realistic doses per\r
   antigen (target × doses-per-child × wastage) — ~50 children gives tens of\r
   doses, not thousands.\r
4. If a day won't save, the message names the field to fix.\r
\r
> Tip: From **All sessions → calendar**, "Plan a session on this day" opens\r
> the New Session form (not the microplan wizard) with the date filled in.\r
\r
## 5. Run a session in the field\r
1. Sidebar → **Sessions** → find today's session.\r
2. **Start session** (works offline).\r
3. **Add client** for each child or pregnant woman vaccinated.\r
   - Pick antigens administered; the next-due dose is preselected.\r
4. When done, **Mark session done** → confirm counts → **Submit**.\r
5. Sync when you're back in range (cloud icon, top-right).\r
\r
## 6. Follow up defaulters\r
1. Sidebar → **Coverage** → **Under-immunised list**.\r
2. Click a child to see their history.\r
3. Click **Create defaulter follow-up session** to schedule outreach.\r
\r
## 7. Track stock\r
1. Sidebar → **Stock**.\r
2. Enter **Receipts** when supply arrives.\r
3. **Issues** are auto-recorded when you close a session.\r
4. At month-end, review and submit the **Monthly stock summary**.\r
\r
<!-- Original section ended here. Added section 8 for Cold Chain Equipment below: -->\r
\r
## 8. Manage Cold Chain Equipment\r
1. Sidebar → **Facilities** → select your facility → **Cold Chain** tab.\r
2. View, add, or edit your facility's refrigerators, freezers, solar direct drive units, vaccine carriers, or generators.\r
3. Select multiple items in the list to trigger the bottom **floating bulk actions** toolbar (e.g. bulk update condition, make active/inactive).\r
4. Use **Import CSV** to import equipment lists or **Export** (CSV/IGA JSON) to share with Inventory and Gap Analysis (IGA) systems.\r
\r
---\r
\r
## Daily checklist\r
\r
- [ ] Open today's sessions before leaving for outreach.\r
- [ ] Capture clients during the session (offline is fine).\r
- [ ] Mark session done before packing up.\r
- [ ] Tap the **sync badge** (top-right) to sync when back in cellular range.\r
- [ ] Skim the **Under-immunised list** weekly for defaulters.\r
- [ ] Submit the **Monthly stock summary** on the last working day.\r
\r
> **Good to know.** When you're online, the app updates on its own\r
> within seconds if anything changes for your facility — no need to\r
> refresh. You only ever see your own facility's data. If a newer\r
> version of the app is published, a banner appears at the top: tap\r
> **Reload** in the browser, or **Download update** in the Windows /\r
> Android app, to get the latest features (your data keeps syncing\r
> either way).\r
\r
## Who to call\r
\r
