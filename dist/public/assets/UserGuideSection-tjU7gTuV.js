import{G as i,u as W,j as n,C as N,D as j,bT as ie,y as U,z as B,bQ as oe,a1 as L,E as Y,a0 as b,cy as se,a4 as le,cp as ce,ah as de,cg as ue,aJ as he}from"./index-DZat5vIZ.js";import{P as pe}from"./progress-Y7jeVbbQ.js";import{A as me,a as ge,b as ye,c as fe}from"./accordion-DFsdRtvZ.js";import{A as ve}from"./award-CXpOQq8g.js";import{T as H}from"./trophy-Cgbdf0AS.js";import{M as Q,r as $}from"./index-ot3f7vS7.js";const we=`# VaxPlan — End-User Guide\r
\r
...
`,be=`# VaxPlan — Facility Staff Quick-Start\r
\r
...
`)}return u&&p.push(u),p.filter(h=>!/table of contents/i.test(h.title))}function Ie({isFacilityRole:c}){const y=i.useMemo(()=>Se(we),[]),[p,u]=i.useState(""),[h,f]=i.useState("All"),[s,_]=i.useState(void 0),[a,M]=i.useState([]),[v,q]=i.useState([]),[z,K]=i.useState({}),[Z,D]=i.useState({}),[O,k]=i.useState(null);i.useEffect(()=>{try{const e=localStorage.getItem("vaxplan.docs.readSections");e&&M(JSON.parse(e));const t=localStorage.getItem("vaxplan.quizzes.completed");t&&q(JSON.parse(t))}catch{}},[]);const C=e=>{M(e);try{localStorage.setItem("vaxplan.docs.readSections",JSON.stringify(e))}catch{}},{data:w=[],isLoading:X}=W({queryKey:["/api/wiki/pages"],queryFn:async()=>{const e=await fetch("/api/wiki/pages");if(!e.ok)throw new Error("Failed to fetch wiki list");return(await e.json()).data},retry:1}),{data:g}=W({queryKey:["/api/wiki/pages",s],queryFn:async()=>{if(!s||s==="quickstart")return null;const e=await fetch(`/api/wiki/pages/${encodeURIComponent(s)}`);if(!e.ok)throw new Error("Failed to fetch page body");return(await e.json()).data},enabled:!!s&&s!=="quickstart"&&w.some(e=>e.slug===s)}),o=i.useMemo(()=>w.length===0?y.map(e=>({...e,category:"General",title:J(e.title),gamification:{quizzes:I[e.id]?[I[e.id]]:[]}})):w.map(e=>{const t=y.find(l=>l.id===e.slug);let r={};try{r=typeof e.gamification=="string"?JSON.parse(e.gamification):e.gamification||{}}catch{}return{id:e.slug,title:J(e.title),category:e.category||"Uncategorized",gamification:r,level:2,body:e.slug===s&&(g!=null&&g.body)?g.body:(t==null?void 0:t.body)??""}}),[w,y,s,g]),x=i.useMemo(()=>{var t;const e=[...ke];for(const r of o)(t=r.gamification)!=null&&t.badges&&Array.isArray(r.gamification.badges)&&e.push(...r.gamification.badges);return Array.from(new Map(e.map(r=>[r.id,r])).values())},[o]),ee=i.useMemo(()=>{var t;const e={...I};for(const r of o)(t=r.gamification)!=null&&t.quizzes&&Array.isArray(r.gamification.quizzes)&&r.gamification.quizzes.length>0&&(e[r.id]=r.gamification.quizzes[0]);return e},[o]),R=i.useMemo(()=>{const e=new Set;return o.forEach(t=>e.add(t.category)),["All",...Array.from(e)].sort()},[o]),A=i.useMemo(()=>{let e=o;h!=="All"&&(e=e.filter(r=>r.category===h));const t=p.trim().toLowerCase();return t?e.filter(r=>r.title.toLowerCase().includes(t)||r.body.toLowerCase().includes(t)):e},[o,p,h]),G=i.useMemo(()=>{const e=o.length+(c?1:0);if(e===0)return 0;let t=a.filter(r=>r==="quickstart"||o.some(l=>l.id===r)).length;return Math.round(t/e*100)},[o,a,c]),V=i.useMemo(()=>{const e=[];a.includes("quickstart")&&e.push("quickstart");for(const r of x)v.includes(r.id)&&e.push(r.id);return o.length>0&&o.every(r=>a.includes(r.id))&&e.push("scholar"),Array.from(new Set(e))},[a,v,o,x]),ne=e=>{let t;a.includes(e)?t=a.filter(r=>r!==e):t=[...a,e],C(t)},te=(e,t)=>{K(r=>({...r,[`${s}-${e}`]:t})),D(r=>({...r,[`${s}-${e}`]:!1}))},re=(e,t)=>{let r=!0;if(t.questions.forEach((l,d)=>{z[`${e}-${d}`]!==l.correctAnswer&&(r=!1),D(S=>({...S,[`${e}-${d}`]:!0}))}),r){if(!v.includes(t.id)){const l=[...v,t.id];q(l);try{localStorage.setItem("vaxplan.quizzes.completed",JSON.stringify(l))}catch{}}a.includes(e)||C([...a,e])}};return n.jsxs("div",{className:"space-y-6",children:[n.jsx(N,{className:"border-indigo-500/20 bg-indigo-50/50 dark:bg-indigo-950/20",children:n.jsx(j,{className:"pt-6",children:n.jsxs("div",{className:"flex flex-col md:flex-row md:items-center justify-between gap-6",children:[n.jsxs("div",{className:"space-y-2 flex-1",children:[n.jsxs("div",{className:"flex items-center gap-2",children:[n.jsx(H,{className:"h-5 w-5 text-indigo-500"}),n.jsx("h2",{className:"font-bold text-base",children:"Your Learning Academy Progress"})]}),n.jsxs("div",{className:"flex items-center justify-between text-xs text-muted-foreground",children:[n.jsxs("span",{children:["Modules Read: ",a.length," of ",o.length+(c?1:0)]}),n.jsxs("span",{children:[G,"% Complete"]})]}),n.jsx(pe,{value:G,className:"h-2 bg-muted-foreground/15"})]}),n.jsxs("div",{className:"border-t md:border-t-0 md:border-l border-indigo-500/10 pt-4 md:pt-0 md:pl-6",children:[n.jsxs("div",{className:"text-xs font-semibold text-indigo-500 uppercase tracking-wider mb-2 flex items-center gap-1.5",children:[n.jsx(ve,{className:"h-4 w-4"})," Unlocked Badges (",V.length," / ",x.length,")"]}),n.jsx("div",{className:"flex gap-2 flex-wrap",children:x.map(e=>{const t=V.includes(e.id);return n.jsxs("div",{title:`${e.name}: ${e.description} (${t?"Unlocked":"Locked"})`,className:`flex items-center gap-1.5 px-2.5 py-1 rounded-full border text-xs font-medium select-none transition-all duration-300 ${t?`bg-gradient-to-r ${e.color||"from-indigo-400 to-blue-500"} text-white border-transparent shadow-sm scale-100 hover:scale-105`:"bg-muted text-muted-foreground/60 border-muted-foreground/15 opacity-60"}`,children:[n.jsx("span",{children:e.icon||"🏆"}),n.jsx("span",{children:e.name}),!t&&n.jsx(ie,{className:"h-3 w-3 ml-0.5 opacity-60"})]},e.id)})})]})]})})}),c&&n.jsxs(N,{className:"border-indigo-500/30 bg-gradient-to-br from-indigo-500/5 to-sky-500/5",children:[n.jsx(U,{className:"pb-3",children:n.jsxs("div",{className:"flex items-center justify-between gap-4 flex-wrap",children:[n.jsxs(B,{className:"flex items-center gap-2 text-base",children:[n.jsx(oe,{className:"h-5 w-5 text-indigo-500"}),"Facility Quick-Start",a.includes("quickstart")&&n.jsxs(L,{variant:"secondary",className:"ml-1 text-xs bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-0 flex items-center gap-0.5",children:[n.jsx(Y,{className:"h-3 w-3"})," Completed"]})]}),n.jsxs("div",{className:"flex gap-2",children:[n.jsx(b,{size:"sm",variant:a.includes("quickstart")?"ghost":"default",className:a.includes("quickstart")?"text-muted-foreground text-xs":"text-xs font-semibold bg-indigo-600 text-white hover:bg-indigo-700",onClick:()=>{const e=a.includes("quickstart");C(e?a.filter(t=>t!=="quickstart"):[...a,"quickstart"])},children:a.includes("quickstart")?"Mark Unread":"Mark as Read"}),n.jsx(b,{size:"sm",variant:"outline",onClick:()=>window.print(),"data-testid":"btn-print-quickstart",children:"Print"})]})]})}),n.jsx(j,{children:n.jsx("article",{className:"prose prose-sm max-w-none dark:prose-invert",children:n.jsx(Q,{remarkPlugins:[$],components:{img:({src:e,alt:t})=>n.jsx("img",{src:e,alt:t,className:"rounded-lg shadow-md max-h-96 object-cover cursor-zoom-in transition-transform hover:scale-[1.01]",onClick:()=>k(e||null)})},children:be})})})]}),n.jsxs(N,{children:[n.jsx(U,{className:"pb-3 border-b",children:n.jsxs("div",{className:"flex items-center justify-between gap-4 flex-wrap",children:[n.jsxs("div",{className:"space-y-1",children:[n.jsxs(B,{className:"flex items-center gap-2 text-base",children:[n.jsx(se,{className:"h-5 w-5 text-indigo-500"}),"VaxPlan End-User Wiki Guide"]}),n.jsx("p",{className:"text-xs text-muted-foreground",children:"Live role-by-role training handbook. Read modules, submit quizzes, and earn badges."})]}),n.jsxs(b,{size:"sm",variant:"outline",className:"gap-1.5","data-testid":"btn-download-guide-pdf",onClick:async()=>{try{if((await fetch("/VaxPlan-User-Guide.pdf",{method:"HEAD"})).ok){const t=document.createElement("a");t.href="/VaxPlan-User-Guide.pdf",t.download="VaxPlan-User-Guide.pdf",t.click()}else window.print()}catch{window.print()}},children:[n.jsx(le,{className:"h-3.5 w-3.5"}),"Download PDF"]})]})}),n.jsxs(j,{className:"space-y-3 pt-4",children:[n.jsxs("div",{className:"flex flex-col sm:flex-row gap-3",children:[n.jsxs("div",{className:"relative flex-1",children:[n.jsx(ce,{"aria-hidden":"true",className:"absolute left-3 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-muted-foreground"}),n.jsx(de,{id:"guide-search",placeholder:"Search guide pages...",value:p,onChange:e=>u(e.target.value),className:"pl-8 h-9 text-sm","data-testid":"input-guide-search"})]}),R.length>1&&n.jsx("select",{value:h,onChange:e=>f(e.target.value),className:"h-9 rounded-md border border-input bg-transparent px-3 py-1 text-sm shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring",children:R.map(e=>n.jsx("option",{value:e,children:e},e))})]}),X&&A.length===0?n.jsx("div",{className:"py-8 text-center text-sm text-muted-foreground",children:"Loading wiki pages from database..."}):A.length===0?n.jsx("p",{className:"text-sm text-muted-foreground py-6 text-center",children:"No matching pages found."}):n.jsx(me,{type:"single",collapsible:!0,value:s,onValueChange:_,children:A.map(e=>{const t=a.includes(e.id),r=ee[e.id],l=r&&v.includes(r.id);return n.jsxs(ge,{value:e.id,children:[n.jsxs(ye,{className:"text-sm hover:no-underline text-left flex items-center justify-between",children:[n.jsxs("div",{className:"flex items-center gap-2",children:[t?n.jsx(Y,{className:"h-4 w-4 text-emerald-500 shrink-0"}):n.jsx("div",{className:"h-4 w-4 border rounded-full shrink-0 border-muted-foreground/30"}),n.jsx("span",{children:e.title})]}),r&&n.jsx(L,{variant:"outline",className:`ml-2 text-[10px] uppercase font-semibold ${l?"bg-emerald-500/10 text-emerald-600 border-0":"bg-indigo-500/10 text-indigo-600 border-indigo-200"}`,children:l?"Quiz Passed ✅":"Quiz Available 📝"})]}),n.jsx(fe,{className:"pt-2",children:s===e.id&&w.length>0&&g===void 0?n.jsx("div",{className:"py-4 text-center text-xs text-muted-foreground",children:"Loading page body..."}):n.jsxs("div",{className:"space-y-6",children:[n.jsx("article",{className:"prose prose-sm max-w-none dark:prose-invert overflow-x-auto [&_table]:block [&_table]:overflow-x-auto [&_table]:whitespace-nowrap [&_table]:max-w-full",children:n.jsx(Q,{remarkPlugins:[$],components:{img:({src:d,alt:m})=>n.jsx("img",{src:d,alt:m,className:"rounded-lg shadow-md max-h-96 object-cover cursor-zoom-in transition-transform hover:scale-[1.01]",onClick:()=>k(d||null)})},children:e.body})}),r&&n.jsxs("div",{className:"border border-indigo-500/20 bg-indigo-50/20 dark:bg-indigo-950/10 rounded-lg p-4 mt-6 space-y-4",children:[n.jsxs("div",{className:"flex items-center gap-2",children:[n.jsx(ue,{className:"h-5 w-5 text-indigo-500"}),n.jsx("h4",{className:"font-bold text-sm text-foreground m-0",children:r.title})]}),n.jsx("div",{className:"space-y-4 divide-y divide-indigo-500/5",children:r.questions.map((d,m)=>{const S=`${e.id}-${m}`,F=z[S],E=Z[S],P=F===d.correctAnswer;return n.jsxs("div",{className:"pt-4 first:pt-0 space-y-2",children:[n.jsxs("p",{className:"text-xs font-semibold text-foreground",children:[m+1,". ",d.question]}),n.jsx("div",{className:"grid gap-2",children:d.options.map((ae,T)=>n.jsx("button",{type:"button",disabled:l,onClick:()=>te(m,T),className:`text-left text-xs px-3 py-2 border rounded-md transition-all ${F===T?E?P?"bg-emerald-500/10 border-emerald-500 text-emerald-600 dark:text-emerald-400 font-medium":"bg-rose-500/10 border-rose-500 text-rose-600 dark:text-rose-400 font-medium":"bg-indigo-500/15 border-indigo-500 font-medium":"bg-background border-muted hover:bg-muted/40"}`,children:ae},T))}),E&&n.jsxs("div",{className:`text-xs p-2 rounded ${P?"bg-emerald-500/5 text-emerald-600":"bg-rose-500/5 text-rose-600"}`,children:[n.jsx("strong",{children:P?"Correct!":"Incorrect."})," ",d.explanation]})]},m)})}),l?n.jsxs("div",{className:"flex items-center justify-center gap-1.5 py-1 text-emerald-500 text-xs font-semibold",children:[n.jsx(H,{className:"h-4 w-4"})," Quiz Completed successfully!"]}):n.jsx(b,{size:"sm",onClick:()=>re(e.id,r),className:"w-full text-xs font-semibold bg-indigo-600 hover:bg-indigo-700 text-white",children:"Submit Quiz Answers"})]}),n.jsxs("div",{className:"flex justify-between items-center border-t pt-4 mt-6",children:[n.jsx("span",{className:"text-xs text-muted-foreground",children:t?"You read this page ✅":"Finished reading?"}),n.jsx(b,{size:"sm",variant:t?"outline":"default",onClick:()=>ne(e.id),className:"text-xs",children:t?"Mark Unread":"Mark as Read"})]})]})})]},e.id)})})]})]}),O&&n.jsxs("div",{onClick:()=>k(null),className:"fixed inset-0 bg-black/80 z-[999] flex items-center justify-center p-4 cursor-zoom-out backdrop-blur-sm",children:[n.jsx("button",{type:"button",className:"absolute top-4 right-4 bg-white/10 hover:bg-white/20 text-white rounded-full p-2",onClick:()=>k(null),children:n.jsx(he,{className:"h-5 w-5"})}),n.jsx("img",{src:O,alt:"Expanded view",className:"max-w-full max-h-[90vh] object-contain rounded-lg shadow-2xl"})]})]})}export{Ie as U};
