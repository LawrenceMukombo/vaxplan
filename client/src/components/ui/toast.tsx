...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // Moved from sm:bottom-0 to sm:top-0 so toasts never cover footer action buttons
      // (e.g. the microplan wizard's Next / Submit / Save Draft row).
      "fixed top-0 z-[100001] flex max-h-screen w-full flex-col-reverse p-4 sm:right-0 sm:top-4 sm:flex-col md:max-w-[420px]",
      className
    )}
    {...props}
  />
